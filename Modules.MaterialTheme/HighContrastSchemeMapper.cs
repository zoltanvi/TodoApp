...
/// <inheritdoc/>
public class HighContrastSchemeMapper : HighContrastSchemeMapper<CorePalette, Scheme<uint>>
{
}
...
/// </summary>
public class HighContrastSchemeMapper<TCorePalette, TScheme> : BaseSchemeMapper<TCorePalette, TScheme>
    ...
    where TScheme : Scheme<uint>, new()
{
    protected override void MapCore(TCorePalette corePalette, TScheme scheme)
    {
        ...
        scheme.Background = corePalette.Neutral[0];
        scheme.OnBackground = corePalette.Neutral[100];
        scheme.Surface = corePalette.Neutral[2];
        ...
        scheme.Surface1 = scheme.Surface.Add(scheme.Primary, .02);
        scheme.Surface2 = scheme.Surface.Add(scheme.Primary, .05);
        scheme.Surface3 = scheme.Surface.Add(scheme.Primary, .08);
        scheme.Surface4 = scheme.Surface.Add(scheme.Primary, .09);
        scheme.Surface5 = scheme.Surface.Add(scheme.Primary, .12);
